package lec07.collectionsproperties04.second;
...
public class PropertiesMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            fis = new FileInputStream("src/main/java/lec07/collectionsproperties04/second/conf.properties");
        ...
        try {
            fos = new FileOutputStream("src/main/java/lec07/collectionsproperties04/second/conf.properties");
