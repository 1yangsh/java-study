...
public class if04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("업무 수행 점수 : ");
        String strWorkScore = scanner.next();
        System.out.print("대인 관계 점수 : ");
        ...
        System.out.println("총 평가 점수 : " + totalScore);
        ...
        if (employeeGrade.equals("S")) {
            ...
            System.out.println("[진급]을 실행전 팀장 재평가를 수행합니다.");
        ...
        if (employeeSalaryGrade.equals("가")) {
            System.out.println("연봉 인상 [가]급을 수행합니다.");
        } else if (employeeSalaryGrade.equals("나")) {
            System.out.println("연봉 인상 [나]급을 수행합니다.");
        } else if (employeeSalaryGrade.equals("다")) {
            System.out.println("연봉 인상 [다]급을 수행합니다.");
        } else if (employeeSalaryGrade.equals("라")) {
            System.out.println("연봉 인상 [라]급을 수행합니다.");
        } else if (employeeSalaryGrade.equals("마")) {
            System.out.println("연봉 인상 [마]급을 수행합니다.");
        } else {
            System.out.println("연봉 인상 [등급 외]급을 수행합니다.");
        }
